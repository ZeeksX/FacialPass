...
const AdminNotifications = ({ courses }) => {
  ...
  return (
    <TableContainer
      component={Paper}
      sx={{ backgroundColor: "transparent", padding: "16px", marginTop: "16px" }}
    >
      <h2 className="text-[#0061A2] text-2xl font-bold text-center mb-4 mt-2">
        Upcoming Exams
      </h2>
      {upcomingExams.length > 0 ? (
        <Table sx={{ backgroundColor: "transparent" }}>
          <TableHead>
            <TableRow>
              <TableCell sx={{ fontWeight: "bold", color: "#0061A2" }}>
                Course Code
              </TableCell>
              <TableCell sx={{ fontWeight: "bold", color: "#0061A2" }}>
                Course Name
