...
const Footer = () => {
    ...
    const contact = [
        { icon: <PhoneAndroidIcon />, feature: "+2349064048598" },
        { icon: <MailOutlineIcon />, feature: "zeeksacademy@gmail.com" },
        { icon: <LocationCityIcon />, feature: "131 Zeeks Avenue, Orlando, Flourida, United States" },
    ]
    const socials = [
    ...
    return (
        <>
            <div className="flex flex-col text-white bg-[#0061A2] w-full pt-4 px-4 md:px-12">
                <div className="flex flex-col lg:flex-row justify-between">
                    ...
                    <div className="flex flex-col gap-3 mt-6">
                        ...
                        {contact.map((item, index) => (
                            <h3
                                className="flex items-end gap-1 flex-row leading-6 text-sm md:text-lg cursor-pointer"
                                key={index}
                            >
                ...
                <h3 className="text-sm text-center mt-12 pb-2">All rights reserved. © 2024 Zeeks Solutions Limited</h3>
            </div>
        </>
