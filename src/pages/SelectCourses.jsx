...
const SelectCourses = () => {
  ...
  }, [student.registeredCourses, setStudent]);

  // Memoize the course cards to avoid unnecessary re-renders
  ...
  }, [currentCourses, handleSelectCourse]);
...
export default React.memo(SelectCourses);